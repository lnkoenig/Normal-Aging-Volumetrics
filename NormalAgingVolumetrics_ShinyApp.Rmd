...
#### by Lauren N. Koenig
Displayed below is the data from the Normal Aging Cohort described [here](https://pubmed.ncbi.nlm.nih.gov/32334404/). The participants are from DIAN and OASIS databases, are amyloid PET negative, and remained cognitively normal for at least 3 year after the displayed MRI. The exception are the amyloid+ participants which can be added, who were also cognitively normal at time of MRI but were amyloid PET positive.
