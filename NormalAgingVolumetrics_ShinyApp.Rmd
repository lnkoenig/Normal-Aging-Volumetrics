...
#### by Lauren N. Koenig
Displayed below is data from the Normal Aging Cohort described in these publications [1](https://pubmed.ncbi.nlm.nih.gov/32334404/) [2](https://pubmed.ncbi.nlm.nih.gov/32334404/). The participants are from DIAN and OASIS databases, are amyloid PET negative, and remained cognitively normal for at least 3 year after the displayed MRI (processed with Freesurfer, primarily version 5.3). The exception are the amyloid+ participants which can be added, who were also cognitively normal at time of MRI but were amyloid PET positive.
Supported by the following grants: U19AG03243, P50AG00561, P30NS09857781, P01AG026276, P01AG003991, R01AG043434, UL1TR000448, R01EB009352, P50AG005681, P01AG026276
        ...
        fluidRow(
          ...
          column(9,
            ...
            fluidRow(
              ...
              column(2, numericInput("ICV", label=h6("Intracranial Volume"), value=1500000))
            )
          )
        ),
        hr(),
        plotOutput("region_plot",  width = "1050px", height = "500px"),
      ),
